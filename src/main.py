...
from flask import make_response, redirect, Flask
...
def authenticated_redirect_target():
    ...
    global client_id, client_secret, redirect_uri, state_auth
    if isinstance(request.args["code"], str) \
        ...
        try:
            ...
            return str(e)
        return "Welcome " + str(userinfo.json()["name"]) + "!"  # Could be a redirect to the main application page
    return "Login failed!"
